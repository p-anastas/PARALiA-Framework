...
double WerkhovenModel_predict(WerkhovenModel_p model, long long h2d_bytes, long long d2h_bytes, double nStreams, short level, long int D1,  long int D2, long int D3);
